        ...
        {slides.map((slide, index) => (
          ...
          >
            <div className="desktop-img-wrapper w-full h-full">
              <Image
                src={slide.img}
                alt={`Brigade Jeevan Sandhya Banner ${index + 1}`}
                width={1920}
                height={800}
            ...
            {slide.mobileImg && (
              <div className="mobile-img-wrapper w-full h-full">
                <Image
                  src={slide.mobileImg}
                  alt={`Brigade Jeevan Sandhya Mobile Banner ${index + 1}`}
                  width={768}
                  height={900}
      ...
      <div className="hero-content">
        ...
        <div className="hero-bullets" style={{ marginBottom: '24px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
          {[
            ...
            "Spread Across 2 Acres of Lush Greenery",
            "Exclusive Pre-Launch on Kanakapura Road",
            "Expected Possession by December 2028"
          ].map((text, i) => (
