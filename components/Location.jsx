...
const locationLandmarks = [
  { name: 'Doddakallsandra Metro', dist: '2 mins' },
  { name: 'Kanakapura Road Market', dist: '~2 km / ~5 mins' },
  { name: 'Sri Kumaran\'s School', dist: '10 mins' },
  { name: 'Astra Super Speciality Hospital', dist: '10 mins' },
  { name: 'NICE Road', dist: '~5 km / ~10 mins' },
  { name: 'Electronic City', dist: '~12 km' },
  { name: 'Bangalore City Center', dist: '~15 km / ~30 mins' },
  { name: 'Kempegowda Int. Airport', dist: '~50 km / ~90 mins' },
]
