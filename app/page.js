...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen bg-white">
      ...
      <div 
        className="hidden lg:flex fixed z-50 cursor-pointer text-white uppercase text-[14px] leading-[20px] font-bold tracking-[0.4px] whitespace-nowrap bg-[#0E4429] items-center justify-center gap-[6px] hover:bg-[#C59A3F] hover:text-white transition-colors duration-300"
        style={{
          top: '50%',
          right: '10px',
      ...
      <div className="fixed bottom-0 left-0 right-0 z-[100] flex shadow-[0_-4px_15px_rgba(0,0,0,0.1)] md:hidden">
        {/* WhatsApp - Left */}
        <a 
          href="https://wa.me/919718344024?text=Hi%2C%20I%20am%20interested%20in%20Brigade%20Jeevan%20Sandhya" 
          target="_blank" 
